...
function preload(){
    ...
    "pics/kiss/4f.png","pics/kiss/5f.png","pics/kiss/6f.png"
   );

    frameImg = loadImage("pics/kiss/b1.png");

    backgroundImage = loadImage("pics/2.jpg")
...
function setup(){
    ...
    middle = createSprite(windowWidth/2,5,windowWidth,windowHeight*0.83);
...
background(backgroundImage)
    ...
    textFont('papyrus')
    textSize(40)
    text("#RahulKiKamna",windowWidth * 0.40,windowHeight * 0.38)
    fill("cyan")
    textFont('papyrus')
    textSize(40)
    
    text("Save  the  date",windowWidth * 0.42,windowHeight * 0.47)
    ...
    stroke("yellow");
    strokeWeight(2)
    text("24.04.2021",windowWidth * 0.42,windowHeight * 0.56)
